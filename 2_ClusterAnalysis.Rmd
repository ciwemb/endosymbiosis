...
Load gene names
```{r}
  id2symbol <- read.table("/mnt/sequence/mhu2/git/mhu2-xelongata/scRNA/wrap_up/data/id2symbol.txt",header=T,sep="\t",quote="\"", stringsAsFactors=F)
...
```
Marker specificity
For a particular gene and cell, We define this gene is enriched in this cell if this cell have a higher expression of this gene than the average expression among all cells.
And for the specificity of marker gene, we define the percentage of cells with enriched marker gene expresion within the cluster.
```{r}
